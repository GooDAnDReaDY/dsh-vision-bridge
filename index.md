...
- Текущий релиз: **0.5.34** (attach-домен для нативных vision-моделей, выдача инструментов по модели, настройки `attachMaxItems`/`hideRedundantTools` в карточке, `DELETE /batch/:id`, исправления стабильности); проверен на тест-контуре MiniPC и на production
