...
- Текущий релиз: **0.5.36** (attach-домен для нативных vision-моделей, выдача инструментов по модели, настройки `attachMaxItems`/`hideRedundantTools` в карточке, `DELETE /batch/:id`, исправления стабильности); проверен на тест-контуре MiniPC и на production
- Тесты: `npm test` — 241/241 (82 suites, 0 fail, ~3.5 с); CI — один прогон на коммит, шаг установки доставляет poppler-utils и ffmpeg
- Milestone: эпик #241 (направления B/C/D — после 0.5.36)
