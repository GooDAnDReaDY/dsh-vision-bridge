...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css =
      ...
      '.vbr-badge-ok{border-color:var(--dsw-alias-state-success-primary);color:var(--dsw-alias-state-success-primary);background:rgba(16,185,129,0.08)}' +
      '.vbr-badge-warn{border-color:var(--dsw-alias-state-warning-primary);color:var(--dsw-alias-state-warning-primary);background:rgba(245,158,11,0.08)}' +
      '.vbr-badge-bad{border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary);background:rgba(239,68,68,0.08)}' +
      '.vbr-badge-neutral{color:var(--dsw-alias-label-secondary)}' +
      '.vbr-toast{position:fixed;bottom:80px;right:24px;z-index:99999;padding:10px 18px;border-radius:8px;font-size:13px;font-weight:500;box-shadow:0 4px 16px rgba(0,0,0,0.3);transition:all 0.3s;color:var(--dsw-alias-bg-layer-3)}' +
