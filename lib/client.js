  ...
  factory: (require) => {
    ...
    function VisionSection(props) {
      ...
      const save = async () => {
        ...
        // #269 review: the settings snapshot below is written before the route
        // answers, so an out-of-range cap would be persisted even though the
        // route rejects it. Validate first and never write an invalid value.
